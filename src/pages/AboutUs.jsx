...
import aboutImg from "../assets/aboutus.png"; // ✅ correct import path
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center max-w-6xl mx-auto">
        ...
        <div>
          <p className="font-sans text-gray-700 text-base md:text-lg leading-relaxed">
            ...
            crafting strategic solutions tailored to propel your business to new
            heights. Our expertise spans a range of services, from mastering{" "}
            <span className="font-semibold">
              Lead Generation, Internet Research, Data Mining, Python Scraping,
              and Influencer Research
            </span>
            .
          </p>
        </div>
